                ...
                <form action="joinResult.php" name="joinResult" method="post" onsubmit="return joinChecks()">
                    <fieldset>
                        ...
                        <div class="over">
                            ...
                            <p class="msg" id="youEmailComment"><!-- 이미 등록되어있는 이메일입니다. 다시확인해주세요.--></p>
                        </div>
                        <div class="over">
                        ...
                        <div>
                            ...
                            <p class="msg" id="youPassComment"><!-- 특수기호, 숫자가 들어가야합니다.--></p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p class="msg" id="youBirthComment"><!-- 생년월일이 정확하지 않습니다.--></p>
                        </div>
                        <div>
                            ...
                            <p class="msg" id="youPhoneComment"><!-- 휴대폰 번호가 정확하지 않습니다.--></p>
                        </div>
